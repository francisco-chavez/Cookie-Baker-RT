...
public struct Vec4 : IFlatbufferObject
{
  ...
  public static Offset<FCT.CookieBakerRT.IPC_DataFormat.Vec4> CreateVec4(FlatBufferBuilder builder, float X, float Y, float Z, float W) {
    builder.Prep(4, 16);
    builder.PutFloat(W);
    builder.PutFloat(Z);
    builder.PutFloat(Y);
    builder.PutFloat(X);
    return new Offset<FCT.CookieBakerRT.IPC_DataFormat.Vec4>(builder.Offset);
  }
};
