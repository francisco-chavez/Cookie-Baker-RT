...
public struct WorkloadRequest : IFlatbufferObject
{
  ...
  public float LightSourceThetaRads { get { int o = __p.__offset(24); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)0.0f; } }
  ...
  public static void AddLightSourceThetaRads(FlatBufferBuilder builder, float LightSourceThetaRads) { builder.AddFloat(10, LightSourceThetaRads, 0.0f); }
