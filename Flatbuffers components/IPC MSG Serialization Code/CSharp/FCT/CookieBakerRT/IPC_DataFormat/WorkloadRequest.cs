...
public struct WorkloadRequest : IFlatbufferObject
{
  ...
  public FCT.CookieBakerRT.IPC_DataFormat.Vec3? LightsourceRightwardDir { get { int o = __p.__offset(26); return o != 0 ? (FCT.CookieBakerRT.IPC_DataFormat.Vec3?)(new FCT.CookieBakerRT.IPC_DataFormat.Vec3()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public FCT.CookieBakerRT.IPC_DataFormat.MeshObject? ObjectData(int j) { int o = __p.__offset(28); return o != 0 ? (FCT.CookieBakerRT.IPC_DataFormat.MeshObject?)(new FCT.CookieBakerRT.IPC_DataFormat.MeshObject()).__assign(__p.__vector(o) + j * 100, __p.bb) : null; }
  public int ObjectDataLength { get { int o = __p.__offset(28); return o != 0 ? __p.__vector_len(o) : 0; } }
  public int Indices(int j) { int o = __p.__offset(30); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int IndicesLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<byte> GetIndicesBytes() { return __p.__vector_as_span(30); }
#else
  public ArraySegment<byte>? GetIndicesBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public int[] GetIndicesArray() { return __p.__vector_as_array<int>(30); }
  public FCT.CookieBakerRT.IPC_DataFormat.Vec3? Vertices(int j) { int o = __p.__offset(32); return o != 0 ? (FCT.CookieBakerRT.IPC_DataFormat.Vec3?)(new FCT.CookieBakerRT.IPC_DataFormat.Vec3()).__assign(__p.__vector(o) + j * 12, __p.bb) : null; }
  public int VerticesLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static void StartWorkloadRequest(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static void AddLightsourceRightwardDir(FlatBufferBuilder builder, Offset<FCT.CookieBakerRT.IPC_DataFormat.Vec3> LightsourceRightwardDirOffset) { builder.AddStruct(11, LightsourceRightwardDirOffset.Value, 0); }
  public static void AddObjectData(FlatBufferBuilder builder, VectorOffset ObjectDataOffset) { builder.AddOffset(12, ObjectDataOffset.Value, 0); }
  public static void StartObjectDataVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(100, numElems, 4); }
  public static void AddIndices(FlatBufferBuilder builder, VectorOffset IndicesOffset) { builder.AddOffset(13, IndicesOffset.Value, 0); }
  ...
  public static void AddVertices(FlatBufferBuilder builder, VectorOffset VerticesOffset) { builder.AddOffset(14, VerticesOffset.Value, 0); }
